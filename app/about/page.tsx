...
import { Award, Clock, MapPin, Users, Target, Heart, Phone, Mail, ChevronDown, ArrowRight } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-slate-900 mb-6">Our Story</h2>
            ...
            <div className="bg-gradient-to-br from-blue-700 to-indigo-800 rounded-xl p-8 text-white shadow-xl">
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-3xl font-serif font-bold">38+ Years</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group bg-white rounded-xl p-6 border border-slate-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 mb-2">Our Mission</h3>
            ...
            <div className="group bg-white rounded-xl p-6 border border-slate-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 mb-2">Our Values</h3>
              <p className="text-slate-600 leading-relaxed text-sm">
            ...
            <div className="group bg-white rounded-xl p-6 border border-slate-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 mb-2">Our Team</h3>
              <p className="text-slate-600 leading-relaxed text-sm">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-serif font-bold text-slate-900 mb-4">Why Choose Digital First?</h2>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-slate-600">Highest quality materials and printing standards</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900">Convenient Locations</h3>
              <p className="text-slate-600">50+ locations across 4 countries</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-slate-600">Experienced professionals at your service</p>
            </div>
          </div>
        </div>
      </section>
